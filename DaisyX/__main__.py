...
DONATE_STRING = """Itan ka lo tangkai ve a,min siamtu hnen ah lawmman i pek ve duh chuan [RSR](t.me/rsrmusic),[Channel](t.me/mizolibrary),"""
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(
                            text="Donate", url="https://paypal.me/rickyzote"
                        )
                    ],
